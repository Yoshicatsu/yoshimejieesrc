...
public class Main
{
    ...
    //tries to load logging properties
    static
    {
        try
        {
    ...
    public static String inputUserMessage(String message )
    {
        return JOptionPane.showInputDialog(frame, message);
    }

    public static void shimejiResponse(String message){
        JOptionPane.showMessageDialog(frame, message, "Shimeji answers:", JOptionPane.PLAIN_MESSAGE);
    }

    //Actual program entry point here
    ...
    private boolean loadConfiguration( final String imageSet )
    {
        try
        {
            ...
            //TODO: Add responseBuilder validation
            ...
            icon.addMouseListener( new MouseListener( )
            {
                ...
                public void mouseReleased( MouseEvent event )
                {
                    if( event.isPopupTrigger( ) )
                    {
                        ...
                        JButton btnTalk = new JButton( "Talk to Shimeji");
                        ...
                        width = Math.max( metrics.stringWidth( btnTalk.getText( ) ), width );
